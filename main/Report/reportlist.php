		...
		<div class="table-responsive">
			<table id="example" class="table table-bordered  table-hover">
				...
				<tbody>
					<?php 
					$i = 1;
					$sql = "SELECT a.Report_ID ,Concat('REF ', LPAD(a.Report_ID ,10,0)) as Reference,
							a.Vehicle_Type,
							a.Vehicle_Plate_No,
							a.Vehicle_Violation,
							a.Vehicle_Color,
					...
					foreach ($cur as $result) {
						...
						echo '<td class="text-center">
								<a href="index.php?q=viewreport&id='.$result->Report_ID.'" class="btn btn-sm btn-outline-secondary"><i class="bi-eye"></i></a>
								<a href="" data-id='.$result->Report_ID.' class="btn btn-sm btn-outline-primary ongoing"><i class="bi-recycle"></i></a>
								<a href="" data-id='.$result->Report_ID.' class="btn btn-sm btn-outline-success solved"><i class="bi-check"></i></a>
							</td>';
